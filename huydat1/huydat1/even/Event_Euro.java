...
public class Event_Euro 
{
    public static short[] idItemCupBac;
    public static short[] idItemCupVang;
    ...
    static {
        idItemCupBac = new short[] { 4, 4, 4, 4, 5, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 7, 8, 9, 242, 249, 251, 254, 255, 275, 276, 277, 278, 289, 289, 340, 340, 409, 410, 436, 436, 436, 436, 436, 437, 437, 443, 485, 524, 549, 550, 551, 569, 577};
        idItemCupVang = new short[] { 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 10, 11, 246, 249, 251, 254, 255, 256, 257, 275, 276, 277, 278, 289, 290, 291, 340, 340, 409, 410, 436, 436, 436, 436, 436, 436, 437, 437, 438, 459, 450, 451, 452, 453, 567, 567, 549, 550, 551, 577, 695, 733, 734, 735, 736, 737, 738, 739, 740, 741, 760, 761, 762, 763, 764, 765, 766, 767, 768, 869};
    ...
    public static void CupBac(Player p, Item item, byte index) {
        ...
        switch (item.id) {
            case 784: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Euro.idItemNgoc[Util.nextInt(Event_Euro.idItemNgoc.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                } else {
                    final short idI = Event_Euro.idItemCupBac[Util.nextInt(Event_Euro.idItemCupBac.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
    ...
    public static void CupVang(Player p, Item item, byte index) {
        ItemTemplate data = ItemTemplate.ItemTemplateId(item.id);
        byte numbagnull = p.c.getBagNull();
        switch (item.id) {
            case 785: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Euro.idItemLDCTA[Util.nextInt(Event_Euro.idItemLDCTA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemXNNLXM[Util.nextInt(Event_Euro.idItemXNNLXM.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemHSHLSX[Util.nextInt(Event_Euro.idItemHSHLSX.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemMNVGTKNC[Util.nextInt(Event_Euro.idItemMNVGTKNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemMNSPONA[Util.nextInt(Event_Euro.idItemMNSPONA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemNC[Util.nextInt(Event_Euro.idItemNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Euro.idItemPet[Util.nextInt(Event_Euro.idItemPet.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
