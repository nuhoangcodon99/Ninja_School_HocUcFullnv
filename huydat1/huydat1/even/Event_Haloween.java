...
public class Event_Haloween 
{
    public static short[] idItemKeoTao;
    public static short[] idItemHopMaQuy;
    ...
    static {
        idItemKeoTao = new short[] { 4, 4, 4, 4, 5, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 7, 8, 9, 242, 249, 251, 254, 255, 275, 276, 277, 278, 289, 289, 340, 340, 409, 410, 436, 436, 436, 436, 436, 437, 437, 443, 485, 524, 549, 550, 551, 569, 577};
        idItemHopMaQuy = new short[] { 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 10, 11, 246, 249, 251, 254, 255, 256, 257, 275, 276, 277, 278, 289, 290, 291, 340, 340, 409, 410, 436, 436, 436, 436, 436, 436, 437, 437, 438, 459, 450, 451, 452, 453, 567, 567, 549, 550, 551, 577, 695, 733, 734, 735, 736, 737, 738, 739, 740, 741, 760, 761, 762, 763, 764, 765, 766, 767, 768, 869};
        ...
        switch (item.id) {
            case 611: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Haloween.idItemNgoc[Util.nextInt(Event_Haloween.idItemNgoc.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                } else {
                    final short idI = Event_Haloween.idItemKeoTao[Util.nextInt(Event_Haloween.idItemKeoTao.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
        ...
        switch (item.id) {
            case 612: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Haloween.idItemLDCTA[Util.nextInt(Event_Haloween.idItemLDCTA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemXNNLXM[Util.nextInt(Event_Haloween.idItemXNNLXM.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemHSHLSX[Util.nextInt(Event_Haloween.idItemHSHLSX.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemMNVGTKNC[Util.nextInt(Event_Haloween.idItemMNVGTKNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemMNSPONA[Util.nextInt(Event_Haloween.idItemMNSPONA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemNC[Util.nextInt(Event_Haloween.idItemNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemPet[Util.nextInt(Event_Haloween.idItemPet.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Haloween.idItemHopMaQuy[Util.nextInt(Event_Haloween.idItemHopMaQuy.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = item.isLock;
                    p.c.addItemBag(true, itemup);
                }
