...
public class Event_He
{
    public static short[] idItemDieuGiay;
    public static short[] idItemDieuVai;
    ...
    static {
        idItemDieuGiay = new short[] { 4, 4, 4, 4, 5, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 7, 8, 9, 242, 249, 251, 254, 255, 275, 276, 277, 278, 289, 289, 340, 340, 409, 410, 436, 436, 436, 436, 436, 437, 437, 443, 485, 524, 549, 550, 551, 569, 577};
        idItemDieuVai = new short[] { 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 10, 11, 246, 249, 251, 254, 255, 256, 257, 275, 276, 277, 278, 289, 290, 291, 340, 340, 409, 410, 436, 436, 436, 436, 436, 436, 437, 437, 438, 459, 450, 451, 452, 453, 567, 567, 549, 550, 551, 577, 695, 733, 734, 735, 736, 737, 738, 739, 740, 741, 760, 761, 762, 763, 764, 765, 766, 767, 768, 869};
    ...
    public static void DieuGiay(Player p, Item item, byte index) {
        ...
        switch (item.id) {
            case 434: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_He.idItemNgoc[Util.nextInt(Event_He.idItemNgoc.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                } else {
                    final short idI = Event_He.idItemDieuGiay[Util.nextInt(Event_He.idItemDieuGiay.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
    ...
    public static void DieuVai(Player p, Item item, byte index) {
        ItemTemplate data = ItemTemplate.ItemTemplateId(item.id);
        byte numbagnull = p.c.getBagNull();
        switch (item.id) {
            case 435: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_He.idItemLDCTA[Util.nextInt(Event_He.idItemLDCTA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemXNNLXM[Util.nextInt(Event_He.idItemXNNLXM.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemHSHLSX[Util.nextInt(Event_He.idItemHSHLSX.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemMNVGTKNC[Util.nextInt(Event_He.idItemMNVGTKNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemMNSPONA[Util.nextInt(Event_He.idItemMNSPONA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemNC[Util.nextInt(Event_He.idItemNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemPet[Util.nextInt(Event_He.idItemPet.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_He.idItemDieuVai[Util.nextInt(Event_He.idItemDieuVai.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = item.isLock;
                    p.c.addItemBag(true, itemup);
                }
