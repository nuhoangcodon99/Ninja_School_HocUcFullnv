...
public class Event_Vulan 
{
    public static short[] idItemBoSenTrang;
    public static short[] idItemBoSenHong;
    ...
    static {
        idItemBoSenTrang = new short[] { 4, 4, 4, 4, 5, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 7, 8, 9, 242, 249, 251, 254, 255, 275, 276, 277, 278, 289, 289, 340, 340, 409, 410, 436, 436, 436, 436, 436, 437, 437, 443, 485, 524, 549, 550, 551, 569, 577};
        idItemBoSenHong = new short[] { 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 10, 11, 246, 249, 251, 254, 255, 256, 257, 275, 276, 277, 278, 289, 290, 291, 340, 340, 409, 410, 436, 436, 436, 436, 436, 436, 437, 437, 438, 459, 450, 451, 452, 453, 567, 567, 549, 550, 551, 577, 695, 733, 734, 735, 736, 737, 738, 739, 740, 741, 760, 761, 762, 763, 764, 765, 766, 767, 768, 869};
        ...
        switch (item.id) {
            case 792: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Vulan.idItemNgoc[Util.nextInt(Event_Vulan.idItemNgoc.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                } else {
                    final short idI = Event_Vulan.idItemBoSenTrang[Util.nextInt(Event_Vulan.idItemBoSenTrang.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
        ...
        switch (item.id) {
            case 793: {
                ...
                if (Util.nextInt(10) < 1) {
                    ...
                    final short idI = Event_Vulan.idItemLDCTA[Util.nextInt(Event_Vulan.idItemLDCTA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemXNNLXM[Util.nextInt(Event_Vulan.idItemXNNLXM.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemHSHLSX[Util.nextInt(Event_Vulan.idItemHSHLSX.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemMNVGTKNC[Util.nextInt(Event_Vulan.idItemMNVGTKNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemMNSPONA[Util.nextInt(Event_Vulan.idItemMNSPONA.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemNC[Util.nextInt(Event_Vulan.idItemNC.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemPet[Util.nextInt(Event_Vulan.idItemPet.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = false;
                    p.c.addItemBag(false, itemup);
                    break;
                    ...
                    final short idI = Event_Vulan.idItemBoSenHong[Util.nextInt(Event_Vulan.idItemBoSenHong.length)];
                    final Item itemup = ItemTemplate.itemDefault(idI);
                    itemup.isLock = item.isLock;
                    p.c.addItemBag(true, itemup);
                }
