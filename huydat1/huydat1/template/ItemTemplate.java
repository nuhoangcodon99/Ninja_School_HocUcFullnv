...
public class ItemTemplate {
    ...
    public static final int[] checkPartHead = new int[]{226, 223, 258, 264, 267, 270, 273, 276, 279};

    public static final int[] check_id = new int[]{73, 102, 103, 105, 114, 115, 116, 117, 118, 119, 120, 121, 124, 125, 126};

   public static short[] idNewItems = new short[]{798,965,969,968,970, 801, 802, 803, 795, 796, 804, 805, 799, 800, 965, 813, 814, 815, 816, 817,828,829,832,833,965};

    public static short[][] idNewItemMounts = new short[][]{
            new short[]{798, 801,965, 802,803, 828, 833,968},
            new short[]{36, 47, 48, 49, 63,72},
    };
    public static short[][] idNewItemCaiTrang = new short[][]{
            new short[]{795, 796, 805, 804,832},
    ...
    public static short[][] idNewItemYoroi= new short[][]{
            new short[]{797,970,969},
            new short[]{43},
    };
    public static short[][] idNewItemBienHinh= new short[][]{
            new short[]{825, 826 ,972,973,974,975,976,977,978,979,980},
            new short[]{61, 62},
    };
    ...
    public static int checkIdCaiTrangNam(int id) {
        Player p = null;
        switch (id) {
            case 0: return 774;
            case 1: return 786;
        ...
        public static int checkIdCaiTrangNu(int id) {
        Player p = null;
        switch (id) {
            case 0: return 774;
            case 1: return 844;
    ...
    public static void divedeItem(Player p, Message m) {
        try {
            ...
            if (quantity > 0 && item != null && item.quantity > 1 && quantity <= item.quantity) {
                ...
                p.lstachdo(p.c.name, p.c.getIndexBag(index).id ,p.c.getIndexBag(index).quantity,quantity);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
