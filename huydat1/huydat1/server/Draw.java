            ...
            String str = m.reader().readUTF();
                ...
                case 207: {
                        ...
                        p.lockAcc();
                            ...
                            if(p.c.diemct < 50000*soluong ) {
                                p.conn.sendMessageLog("Bạn không đủ điểm chiến thần");
                                return;
                            }
                            ...
                            if (p.c.getBagNull() == 0) {
                                ...
                                p.c.diemct -= 50000*soluong;
                                Item it = ItemTemplate.itemDefault(966);
                                it.quantity = (int)(1*soluong);
                                p.c.addItemBag(true, it);
                            }
                            return;
...
case 123:
                   ...
                   if(a21 == null) {
                    ...
                    case 310: {
                        ...
                        p.tencu = str;
                        p.changeName();
                        Server.menu.sendWrite(p, (short) 311, "Nhập tên hiện tại ");
                        break;
                    }
                    case 311: {
                        p.tenmoi = str;
...
//skgiaikhac
            ...
            case 1400: {
               ...
               if (p.c.quantityItemyTotal(304) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
               ...
               if (p.c.quantityItemyTotal(305) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
           ...
           if (p.c.yen >= 50000*soluong && p.c.xu >= 1000*soluong && p.c.quantityItemyTotal(292) >= 3*soluong && p.c.quantityItemyTotal(293) >= 2*soluong && p.c.quantityItemyTotal(294) >= 3*soluong) {
            //   if (p.c.quantityItemyTotal(305) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
           ...
           if (p.c.yen >= 50000*soluong && p.c.xu >= 1000*soluong && p.c.quantityItemyTotal(292) >= 2*soluong && p.c.quantityItemyTotal(295) >= 3*soluong && p.c.quantityItemyTotal(294) >= 2*soluong) {
            //   if (p.c.quantityItemyTotal(305) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
           ...
           if (p.c.yen >= 50000*soluong && p.c.xu >= 1000*soluong && p.c.quantityItemyTotal(292) >= 2*soluong && p.c.quantityItemyTotal(295) >= 3*soluong && p.c.quantityItemyTotal(297) >= 3*soluong) {
            //   if (p.c.quantityItemyTotal(305) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
           ...
           if (p.c.yen >= 50000*soluong && p.c.xu >= 1000*soluong && p.c.quantityItemyTotal(292) >= 2*soluong && p.c.quantityItemyTotal(296) >= 2*soluong && p.c.quantityItemyTotal(297) >= 3*soluong) {
            //   if (p.c.quantityItemyTotal(305) >= 1*soluong && p.c.quantityItemyTotal(298) >= 1*soluong && p.c.quantityItemyTotal(299) >= 1*soluong && p.c.quantityItemyTotal(300) >= 1*soluong && p.c.quantityItemyTotal(301) >= 1*soluong) {                         
                            if (p.c.getBagNull() == 0) {
                                p.conn.sendMessageLog("Hành trang không đủ chỗ trống");
                            } else {
