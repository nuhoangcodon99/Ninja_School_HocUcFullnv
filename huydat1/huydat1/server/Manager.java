...
public class Manager {
            ...
            if (i != data.length() && (es = data.charAt(i)) != '\n') {
                ...
                if (sbf != null && !sbf.equals("") && sbf.charAt(0) != '#') {
                    ...
                    if (j > 0) {
                        ...
                        System.err.println("Cấu hình: " + key + "-" + value);
                    }
                }
                sbd.setLength(0);
            }
    ...
    private void loadDataBase() {
        ...
        try {
            ...
            res.close();
             System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_arrow) ...Done");
            i = 0;
            ...
            res.close();
                       System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_effect) ...Done");
                       i = 0;
            ...
            res.close();
                       System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_skill) ...Done");
            i = 0;
            ...
            //part
            i = 0;
             System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_part) ...Done");
            ...
            res.close();
                       System.out.println("VŨ HUY ĐẠT: level ...Done");
            i = 0;
            ...
            res.close();
            i = 0;
                       System.out.println("VŨ HUY ĐẠT: effect ...Done");
            ...
            i = 0;
                                   System.out.println("VŨ HUY ĐẠT: mob ...Done");
            int k;
            ...
            res.close();
             System.out.println("VŨ HUY ĐẠT: npc ...Done ");
...
System.out.println("VŨ HUY ĐẠT: itemcay ...Done");
            ...
            i = 0;
                      System.out.println("VŨ HUY ĐẠT: Item ...Done");
            JSONObject job;
            ...
            i = 0;
                      System.out.println("VŨ HUY ĐẠT: skill ...Done");
            ...
            i = 0;
                      System.out.println("VŨ HUY ĐẠT: itemsell ...Done");
    ...
    private void loadGame() {
        try {
                  System.out.println("VŨ HUY ĐẠT: clan ...Done");
 ...
 System.out.println("VŨ HUY ĐẠT: thiên địa bảng ...Done");
            ...
            res.close();
 System.out.println("VŨ HUY ĐẠT: shinwa ...Done");
