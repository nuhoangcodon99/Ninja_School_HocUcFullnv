...
public class Map {
    ...
    public static int[] arrvhd1 = new int[] { 180,181,182,183};
  ...
  public static int[] arrTuTien = new int[] {168};
    ...
    public boolean mapvhd1() {
         if (this.id == 180 || this.id == 181 || this.id == 182 || this.id == 183) {
            return true;
        }
       return false;
    }
            ...
            if (i == area) {
                ...
                for (j = 0; j < tileMap.mobs.size(); ++j) {
                    ...
                    if (mob != null && mob.status == 0 && mob.isboss) {
                        ...
                        System.err.println("Xuất Hiện Boss: " + mob.templates.name +" => Tại Map: "+ tileMap.map.id +" => Khu: "+tileMap.id);
                    }
                }
                break;
            }
