...
import huydat.cache.ArrowPaint;
import huydat.cache.EffectCharPaint;
import huydat.cache.EffectInfoPaint;
...
import huydat.stream.EventClan;
...
import huydat.cache.SkillInfoPaint;
import huydat.cache.SkillOptionTemplates;
import huydat.cache.SkillPaint;
...
public class Manager {
    ...
    HashMap<Integer, Integer> npcCount = new HashMap<>();
    public int acclimitIP = 0; /// so acc /ip
    ...
    public Manager() {
        ...
        this.NinjaS = new String[]{"Chưa vào lớp", "Ninja Kiếm", "Ninja Phi Tiêu", "Ninja Kunai", "Ninja Cung", "Ninja Đao", "Ninja Quạt", "Ninja Hắc Ám"};
        ...
        this.OptionsTuTien = new String[]{"Ở tầng này cơ thể con chưa được tăng cái gì hết tu luyện thêm đi",// tầng 0
                                            Title + TAN_CONG_NGUOI + "500\n" + TAN_CONG_QUAI + "500\n" + TANG_HP + "500\n", // tầng 1
                                            Title + TAN_CONG_NGUOI + "500\n" + TAN_CONG_QUAI + "500\n" + TANG_HP + "1000\n" + TAN_CONG + "1000", // tầng 2
                                            Title + TAN_CONG_NGUOI + "550\n" + TAN_CONG_QUAI + "550\n" + TANG_HP + "1000\n" + TAN_CONG + "1500", // tầng 3
                                            Title + TAN_CONG_NGUOI + "550\n" + TAN_CONG_QUAI + "550\n"+ TANG_HP + "1500\n" + TAN_CONG + "2000", //tầng 4
                                            Title + TAN_CONG_NGUOI + "600\n" + TAN_CONG_QUAI + "600\n" + TANG_HP + "1500\n" + TAN_CONG + "2500",// tầng 5
                                            Title + TAN_CONG_NGUOI + "600\n" + TAN_CONG_QUAI + "600\n" + TANG_HP + "2000\n" + TAN_CONG + "3000\n" + GIAM_SAT_THUONG + "60",// tầng 6
                                            Title + TAN_CONG_NGUOI + "650\n" + TAN_CONG_QUAI + "650\n" + TANG_HP + "2000\n" + TAN_CONG + "3500\n" + GIAM_SAT_THUONG + "70",// tầng 7
                                            Title + TAN_CONG_NGUOI + "650\n" + TAN_CONG_QUAI + "650\n" + TANG_HP + "2500\n" + TAN_CONG + "4000\n" + GIAM_SAT_THUONG + "80",// tầng 8
                                            Title + TAN_CONG_NGUOI + "700\n" + TAN_CONG_QUAI + "700\n" + TANG_HP + "3000\n" + TAN_CONG + "4500\n" + GIAM_SAT_THUONG + "90",// tầng 9
                                            Title + TAN_CONG_NGUOI + "700\n" + TAN_CONG_QUAI + "700\n" + TANG_HP + "3000\n" + TAN_CONG + "5000\n" + GIAM_SAT_THUONG + "100\n",// tầng 10
                                            Title + TAN_CONG_NGUOI + "750\n" + TAN_CONG_QUAI + "750\n" + TANG_HP + "3500\n" + TAN_CONG + "5500\n" + GIAM_SAT_THUONG + "110\n" + X2_CHI_MANG + "3%",// tầng 11
                                            Title + TAN_CONG_NGUOI + "750\n" + TAN_CONG_QUAI + "750\n" + TANG_HP + "3500\n" + TAN_CONG + "6000\n" + GIAM_SAT_THUONG + "120\n" + X2_CHI_MANG + "4%",// tầng 12
                                            Title + TAN_CONG_NGUOI + "800\n" + TAN_CONG_QUAI + "800\n" + TANG_HP + "4000\n" + TAN_CONG + "6500\n" + GIAM_SAT_THUONG + "130\n" + X2_CHI_MANG + "5%",// tầng 13
                                            Title + TAN_CONG_NGUOI + "800\n" + TAN_CONG_QUAI + "800\n" + TANG_HP + "4000\n" + TAN_CONG + "7000\n" + GIAM_SAT_THUONG + "140\n" + X2_CHI_MANG + "6%",// tầng 14
                                            Title + TAN_CONG_NGUOI + "850\n" + TAN_CONG_QUAI + "850\n" + TANG_HP + "4500\n" + TAN_CONG + "7500\n" + GIAM_SAT_THUONG + "150\n" + X2_CHI_MANG + "7%",// tầng 15
                                            Title + TAN_CONG_NGUOI + "850\n" + TAN_CONG_QUAI + "850\n" + TANG_HP + "5000\n" + TAN_CONG + "8000\n" + GIAM_SAT_THUONG + "160\n" + X2_CHI_MANG + "8%\n" + HUT_MAU_NGUOI + "3%\n "+ HUT_MAU_QUAI + "2% ",// tầng 16
                                            Title + TAN_CONG_NGUOI + "900\n" + TAN_CONG_QUAI + "900\n" + TANG_HP + "5500\n" + TAN_CONG + "8500\n" + GIAM_SAT_THUONG + "170\n" + X2_CHI_MANG + "9%\n" + HUT_MAU_NGUOI + "4%\n "+ HUT_MAU_QUAI + "4% ",// tầng 17
                                            Title + TAN_CONG_NGUOI + "950\n" + TAN_CONG_QUAI + "900\n" + TANG_HP + "6000\n" + TAN_CONG + "9000\n" + GIAM_SAT_THUONG + "180\n" + X2_CHI_MANG + "10%\n" + HUT_MAU_NGUOI + "5%\n "+ HUT_MAU_QUAI + "6% ",// tầng 18
                                            Title + TAN_CONG_NGUOI + "950\n" + TAN_CONG_QUAI + "950\n" + TANG_HP + "6500\n" + TAN_CONG + "9500\n" + GIAM_SAT_THUONG + "190\n" + X2_CHI_MANG + "11%n" + HUT_MAU_NGUOI + "6%\n "+ HUT_MAU_QUAI + "8% ",// tầng 19
                                            Title + TAN_CONG_NGUOI + "1000\n" + TAN_CONG_QUAI + "950\n" + TANG_HP + "7000\n" + TAN_CONG + "1000\n0" + GIAM_SAT_THUONG + "200\n" + X2_CHI_MANG + "12%\n" +  HUT_MAU_NGUOI + "7%\n "+ HUT_MAU_QUAI + "10% ",// tầng 20
                                            Title + TAN_CONG_NGUOI + "1000\n" + TAN_CONG_QUAI + "1000\n" + TANG_HP + "8000\n" + TAN_CONG + "10500\n" + GIAM_SAT_THUONG + "210\n" + X2_CHI_MANG + "13%\n" + HUT_MAU_NGUOI + "8%\n "+ HUT_MAU_QUAI + "12% ",// tầng 21
                                            Title + TAN_CONG_NGUOI + "1050\n" + TAN_CONG_QUAI + "1050\n" + TANG_HP + "9000\n" + TAN_CONG + "11000\n" + GIAM_SAT_THUONG + "220\n" + X2_CHI_MANG + "14%\n" +  HUT_MAU_NGUOI + "9%\n "+ HUT_MAU_QUAI + "14% ",// tầng 22
                                            Title + TAN_CONG_NGUOI + "1100\n" + TAN_CONG_QUAI + "1100\n" + TANG_HP + "10000\n" + TAN_CONG + "12000\n" + GIAM_SAT_THUONG + "230\n" + X2_CHI_MANG + "15%\n" + HUT_MAU_NGUOI + "10%\n "+ HUT_MAU_QUAI + "16% ",// tầng 23
        };
    ...
    private void loadConfigFile() {
            ...
            if (i != data.length() && (es = data.charAt(i)) != '\n') {
                ...
                if (sbf != null && !sbf.equals("") && sbf.charAt(0) != '#') {
                    ...
                    if (j > 0) {
                        ...
                        System.err.println("\033[0;32mHuy Đạt: " + key + " <0> " + value + "\033[0m");
                    }
                }
                sbd.setLength(0);
            }
        ...
        if (configMap.containsKey("Giới Hạn Ip")) {
    ...
    private void loadDataBase() {
        ...
        int i = 0;
        try {
             System.out.println("VŨ HUY ĐẠT: Nhiệm Vụ ...Done");
            ...
            while (res.next()) {
             ...
             System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_arrow) ...Done "+ arrs.size());
            res.close();
            i = 0;
            ...
            System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_effect) ...Done " + smallImg.size());
            res.close();
            i = 0;
            ...
            System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_skill) ...Done " + sks.size());
            res.close();
            //part
            i = 0;
            ...
            while (res.next()) {
             ...
             System.err.println("VŨ HUY ĐẠT: tải dữ liệu (nj_part) ...Done " + parts.size());
            res.close();
            i = 0;
           ...
           System.out.println("VŨ HUY ĐẠT: level ...Done " + (Level.entrys.size() - 1)); 
            res.close();
            i = 0;
            ...
            System.out.println("VŨ HUY ĐẠT: effect ...Done " + EffectTemplate.entrys.size());
            res.close();
            i = 0;
            int k;
            for (res = SQLManager.stat.executeQuery("SELECT * FROM `mob`;"); res.next(); ++i) {
             ...
             System.out.println("VŨ HUY ĐẠT: mob ...Done "+ MobTemplate.entrys.size());
            res.close();
            ...
            System.out.println("VŨ HUY ĐẠT: npc ...Done "+ npcs.size());
            res.close();
            ...
            System.out.println("VŨ HUY ĐẠT: map ...Done ");
            System.out.println("VŨ HUY ĐẠT: itemcay ...Done");
            res.close();
            ...
            for (res = SQLManager.stat.executeQuery("SELECT * FROM `item`;"); res.next(); ++i) {
             ...
             System.out.println("VŨ HUY ĐẠT: Item ...Done "+ ItemTemplate.entrys.size());
            res.close();
            ...
            for (res = SQLManager.stat.executeQuery("SELECT * FROM `skill`;"); res.next(); ++i) {
             ...
             System.out.println("VŨ HUY ĐẠT: skill ...Done "+ SkillTemplate.entrys.size());
            res.close();
            ...
            try {
                ...
                System.out.println("VŨ HUY ĐẠT: optionskill ...Done");
                res.close();
            } catch (Exception e) {
                e.printStackTrace();
                System.exit(0);
            ...
            for (res = SQLManager.stat.executeQuery("SELECT * FROM `itemsell`;"); res.next(); ++i) {
             ...
             System.out.println("VŨ HUY ĐẠT: itemsell ...Done "+ ItemSell.entrys.size());
            res.close();
    ...
    private void loadGame() {
        try {
            ...
            while(res.next()) {
                ...
                clan.EventClan = res.getByte("EventClan");
            ...
            System.out.println("VŨ HUY ĐẠT: clan ...Done "+ ClanManager.entrys.size());
            res.close();
 System.out.println("VŨ HUY ĐẠT: alert ...Done");
            ...
            res.close();
 System.out.println("VŨ HUY ĐẠT: thiên địa bảng ...Done");
            ...
            System.out.println("VŨ HUY ĐẠT: shinwa ...Done "+ ShinwaManager.entrys.size());
            res.close();
